"""Generate B14 sweep configs: 5 dimensions upscaling (32, 64, 128, 256, 512).
Logarithmic flow depth scaling: (4, 6, 8, 10, 12).

Fixed: dataset=nd-kf-mlp, shared_factor_dist=normal, mlp_depth=3, k_shared=3, m_unique=0.
"""
import yaml
...
def generate_configs():
    ...
    generated = []
    for num_dims, stage_count in scale_params:
        config_name = f"B14_{num_dims}D_S{stage_count}"
        ...
        cfg = {
            ...
            "logging": {
                ...
                "save_every": 100,
                "tqdm_silent": False,
                "wandb_group": "B14_scaling_up_z_dim",
            },
        }
