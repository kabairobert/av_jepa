"""Generate B16b sweep configs: 6 dimensions upscaling (16, 32, 64, 128, 256, 512).
Logarithmic flow depth scaling with increased width for 512D:
  - 16D  -> S=6,   hidden_units=128
...
Fixed: dataset=nd-kf-mlp, shared_factor_dist=normal, mlp_depth=2, k_shared=3, m_unique=num_dims-3, noise=0.02, epochs=100.
"""
import yaml
...
def generate_configs():
    ...
    cfg_dir = base_dir / "cfgs" / "B16b_capacity_scaling_fixed"
    ...
    for num_dims, stage_count, hidden_units in scale_params:
        config_name = f"B16b_{num_dims}D_S{stage_count}"
        ...
        cfg = {
            ...
            "logging": {
                ...
                "save_every": 100,
                "tqdm_silent": False,
                "wandb_group": "B16b_capacity_scaling_fixed",
            },
        }
