...
noise_levels = {
    ...
    3: {"asymmetric_noise_rate_a": 0.25, "asymmetric_noise_rate_b": 0.25, "external_noise_ratio": 0.00},
    4: {"asymmetric_noise_rate_a": 0.00, "asymmetric_noise_rate_b": 0.00, "external_noise_ratio": 0.10},
    5: {"asymmetric_noise_rate_a": 0.00, "asymmetric_noise_rate_b": 0.00, "external_noise_ratio": 0.30},
    6: {"asymmetric_noise_rate_a": 0.00, "asymmetric_noise_rate_b": 0.00, "external_noise_ratio": 0.50},
}
...
def get_base_cfg():
    return {
        ...
        "logging": {
            ...
            "save_every": 150,
            "tqdm_silent": False,
            "wandb_group": "B08_volumetric_alignment"
        }
    }
...
def main():
    ...
    for n_idx, n_params in noise_levels.items():
        for p1_idx, p1_params in prior_levels.items():
            for p2_idx, p2_params in pred_levels.items():
                ...
                name = f"B08_NPP{n_idx}{p1_idx}{p2_idx}.yaml"
    ...
    print(f"Generated {count} B08 configuration files in {CFG_DIR}")
