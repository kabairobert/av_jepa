"""Generate B16c sweep configs: 6 dimensions upscaling (16, 32, 64, 128, 256, 512).
...
def generate_configs():
    ...
    cfg_dir = base_dir / "cfgs" / "B16c_capacity_scaling_fixed"
    ...
    for num_dims, stage_count, hidden_units in scale_params:
        config_name = f"B16c_{num_dims}D_S{stage_count}"
