...
class DualDisentangleDataset(Dataset):
    """Synthetic or file-based paired dataset (Modality A & B) from a shared 1D latent."""
    def __init__(self, data_type='2d', num_samples=4096, path_a=None, path_b=None):
        ...
        self.corr_target = torch.tensor(np.tile([0.0, 0.9], (self.num_samples, 1)), dtype=torch.float64) # Dummy target for original loss
